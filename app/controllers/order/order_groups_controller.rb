class Order::OrderGroupsController < ApplicationController
  include FormHelper, ModalHelper, PageHelper, TableHelper

  def new
    form = new_form_prep_record(Order::OrderGroupForm)
  ...
  def index
    ...
    table = new_table_prep_records(Table::Order::OrderGroupsIndexTable)
