...
class Order::OrderGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  def setup
    ...
    @disabled_record = order_order_groups(:disabled)
    ...
    @ph = { :description => "New Order Group For Create Test" }
  ...
  test "a order groups ap user can get new modal" do
    to = NewTO.new(@nothing_ap_user, @new, true)
    to.enable_model_permission
    to.test(self)
  end

  test "a order groups ap(disabled) user can't get new modal" do
    to = NewTO.new(@nothing_ap_user, @new, false)
    to.enable_model_permission
    to.disable_user_access_policy
    to.test(self)
  ...
  test "a order groups ap shipper user can't get new modal" do
  ...
  test "new modal title" do
    to = NewTO.new(@everything_ap_user, @new, true)
    to.visibles << NewModalTitleVisible.new(model_class: Order::OrderGroup)
    to.test(self)
  end
  ...
  test "a order groups ap user can create" do
    to = CreateTO.new(@nothing_ap_user, @new, true, params_hash: @ph)
    to.enable_model_permission
    to.test(self)
  end

  test "a order groups ap(disabled) user can't create" do
  ...
  test "a order groups ap shipper user can't create" do
  ...
  test "edit modal title" do
    ...
    to.visibles << EditModalTitleVisible.new(model_class: Order::OrderGroup)
    to.test(self)
  end
  ...
  test "a order groups ap user can get the edit modal" do
    to = EditTO.new(@nothing_ap_user, @record_1, true)
    to.enable_model_permission
    to.test(self)
  end

  test "a order groups ap(disabled) user can't get the edit modal" do
  ...
  test "a order groups ap user can update" do
  ...
  test "a order groups ap(disabled) user can't update" do
    to = UpdateTO.new(@nothing_ap_user, @record_1, false, params_hash: @phu)
    to.update_fields = @update_fields
    to.enable_model_permission
    to.disable_user_access_policy
  ...
  test "a order groups ap user can index" do
    to = IndexTo.new(@nothing_ap_user, @new, true)
    to.enable_model_permission
    to.test(self)
  end

  test "a order groups ap(disabled) user can't index" do
  ...
  test "a order groups ap shipper user can't index" do
  ...
  test "page title should be there" do
    to = IndexTo.new(@everything_ap_user, @new, true)
    to.visibles << IndexRecordsTitleVisible.new(model_class: Order::OrderGroup)
    to.test(self)
  end
